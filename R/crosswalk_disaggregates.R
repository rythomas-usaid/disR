...
d4 <-  dplyr::bind_rows(
  ...
  ## Females
  tibble::tibble(ic = "EG.3-10-11-12"
  ...
  tibble::tibble(ic = "EG.3.2-27", ms_d4 = "15-29", name = "15-29"
  ),
  ##30+##
  tibble::tibble(ic = "EG.3.2-27"
  ...
  tibble::tibble(ic = "EG.3.2-27", ms_d4 = "30+", name = "30+"
  ),

  #### EG.3.2-x19 (Sales) ####
  tibble::tibble(ic = "EG.3.2-x19", ms_d2 = "Number of direct beneficiaries"
         , name = "Number of Participants"
  ),
  tibble::tibble(ic = "EG.3.2-x19", ms_d2 = "Reporting year sales"
         , name = "Value of Sales"
  ),
  tibble::tibble(ic = "EG.3.2-x19", name = "process"
  )
)
...
d3 <-  dplyr::bind_rows(
  ...
  ##EG.3.1-c
  ##Value of exports##
  tibble::tibble(ic = "EG.3.1-c", udn = "3.1.1", name = "Value of Exports (USD)"
  ),
  ##Volume of exports##
  tibble::tibble(ic = "EG.3.1-c", udn = "3.1.2", name = "Volume of Exports (MT)"
  ),
  tibble::tibble(ic = "EG.3-10-11-12"
         , udn = c("3.1.1.1.8.1.2", "3.1.1.1.9.1.2", "3.1.1.1.10.1.2"
                   , "3.1.1.2.8.1.2", "3.1.1.2.9.1.2", "3.1.1.2.10.1.2"
  ...
  tibble::tibble(ic = "EG.3.2-24", ms_d2 = c("Sex (no double-counting)"
                                     , "Age category (no double-counting)"
                                     , "Management Practice or Tech Type (double-counting allowed)"
  ...
  tibble::tibble(ic = "EG.3.2-25"
         , udn = c("3.1.1.1", "3.2.1.1", "3.3.1.1", "3.4.1.1", "3.5.1.1"
                   , "3.6.1.1", "3.7.1.1")
         , name = "Male"
  ),
  tibble::tibble(ic = "EG.3.2-25", ms_d3 = "Male"
         , name = "Male"
  ),
  tibble::tibble(ic = "EG.3.2-25"
         , udn = c("3.1.1.2", "3.2.1.2", "3.3.1.2", "3.4.1.2", "3.5.1.2"
  ...
  tibble::tibble(ic = "EG.3.2-25", ms_d2 ="Commodity"
         , name = "ms_d3"
         ##EG.3.2-26 (USD by Sex)##
         ##Female##
  ),
  ...
  tibble::tibble(ic = "EG.3.2-x17", ms_d2 = c("Sex", "Commodity", "Duration")
         , name = "ms_d3"
  ),
  tibble::tibble(ic = "EG.3.2-x17"
  ...
  tibble::tibble(ic = "EG.3.2-x18", ms_d2 = c("animal genetics")
         , name = "Animal Genetics"
  ),
  tibble::tibble(ic = "EG.3.2-x18", ms_d2 ="climate adaptation"
         , name = "Climate Adaptation"
  ),
  tibble::tibble(ic = "EG.3.2-x18", ms_d2 ="climate mitigation"
         , name = "Climate Mitigation"
  ),
  tibble::tibble(ic = "EG.3.2-x18", ms_d2 ="climate mitigation or adaptation"
         , name = "Climate Mitigation or Adaptation"
  ),
  tibble::tibble(ic = "EG.3.2-x18", ms_d2 ="crop genetics"
         , name = "Crop Genetics"
  ),
  tibble::tibble(ic = "EG.3.2-x18", ms_d2 ="cultural practices"
         , name = "Cultural Practices"
  ),
  tibble::tibble(ic = "EG.3.2-x18", ms_d2 ="disease management"
         , name = "Disease Management"
  ),
  tibble::tibble(ic = "EG.3.2-x18", ms_d2 ="fishing gear/technique"
         , name = "Fishing Gear/Technique"
  ),
  tibble::tibble(ic = "EG.3.2-x18", ms_d2 ="irrigation"
         , name = "Irrigation"
  ),
  tibble::tibble(ic = "EG.3.2-x18", ms_d2 ="other"
         , name = "Other"
  ),
  tibble::tibble(ic = "EG.3.2-x18", ms_d2 ="pest management"
         , name = "Pest Management"
  ),
  tibble::tibble(ic = "EG.3.2-x18", ms_d2 ="post-harvest handling and storage"
         , name = "Post-Harvest Handling and Storage"
  ),
  tibble::tibble(ic = "EG.3.2-x18", ms_d2 ="processing"
         , name = "Processing"
  ),
  tibble::tibble(ic = "EG.3.2-x18", ms_d2 ="soil-related fertility and conservation"
         , name = "Soil-Related Fertility and Conservation"
  ),
  tibble::tibble(ic = "EG.3.2-x18", ms_d2 ="total w/one or more improved technology"
         , name = "Total With One or More Improved Technology"
  ),
  tibble::tibble(ic = "EG.3.2-x18", ms_d2 ="water management (non-irrigation)"
         , name = "Water Management (Non-Irrigation)"
  ),
  tibble::tibble(ic = "EG.3.2-x18", ms_d2 ="Association-applied"
         , name = "Association-Applied"
  ),
  tibble::tibble(ic = "EG.3.2-x18"
         , name = "ms_d2"
         ##EG.3.2-x19 (Sales)##
  ),
  tibble::tibble(ic = "EG.3.2-x19"
         , name = "No Age/Sex Information Collected"
         ##EG.10.4-7 (Resource Type)##
         ##Sex##
  ),
  tibble::tibble(ic = "EG.10.4-7"
...
d2 <-   dplyr::bind_rows(
  ...
  ## EG-c ####
  tibble::tibble(ic = "EG-c", udn ="3.1.1"
         , name = "In All ZOIs/Areas Combined (%)"
  ),
  tibble::tibble(ic = "EG-c", udn ="3.1.2"
         , name = "In Target/Aligned Country ZOI (%)"
  ),
  tibble::tibble(ic = "EG-c", udn ="3.1.3"
         , name = "In FFP Development Program Area (%)"
  ),
  tibble::tibble(ic = "EG-c", udn ="3.1.4"
         , name = "In Resilience to Recurrent Crisis Area (%)"
         ##Number of people (all household types together)##
  ),
  tibble::tibble(ic = "EG-c", udn ="3.2.1"
         , name = "In All ZOIs/Areas Combined"
  ),
  tibble::tibble(ic = "EG-c", udn ="3.2.2"
         , name = "In Target/Aligned Country ZOI"
  ),
  tibble::tibble(ic = "EG-c", udn ="3.2.3"
         , name = "In FFP Development Program Area"
  ),
  tibble::tibble(ic = "EG-c", udn ="3.2.4"
         , name = "In Resilience to Recurrent Crisis Area"
         ##Household type: Male and Female Adults (M&F)##
         ##Percent of people living on less than $1.90/day in this gendered household type##
  ),
  ...
  ## EG-d ####
  tibble::tibble(ic = "EG-d", udn ="3.2.1.1"
         , name = "Percent of People Living on Less than $1.90/Day in this Gendered Household Type"
         ##Number of people in this gendered household type##
  ),
  tibble::tibble(ic = "EG-d", udn ="3.2.1.2"
         , name = "Number of People in this Gendered Household Type"
         ##Household type: Adult Female no Adult Male (FNM)##
         ##Percent of people living on less than $1.90/day in this gendered household type##
  ),
  tibble::tibble(ic = "EG-d", udn ="3.2.2.1"
         , name = "Percent of People Living on Less than $1.90/Day in this Gendered Household Type"
         ##Number of people in this gendered household type##
  ),
  tibble::tibble(ic = "EG-d", udn ="3.2.2.2"
         , name = "Number of People in this Gendered Household Type"
         ##Household type: Adult Male no Adult Female (MNF)##
         ##Percent of people living on less than $1.90/day in this gendered household type##
  ),
  tibble::tibble(ic = "EG-d", udn ="3.2.3.1"
         , name = "Percent of People Living on Less than $1.90/Day in this Gendered Household Type"
         ##Number of people in this gendered household type##
  ),
  tibble::tibble(ic = "EG-d", udn ="3.2.3.2"
         , name = "Number of People in this Gendered Household Type"
         ##Household type: Child No Adults (CNA)##
         ##Percent of people living on less than $1.90/day in this gendered household type##
  ),
  tibble::tibble(ic = "EG-d", udn ="3.2.4.1"
         , name = "Percent of People Living on Less than $1.90/Day in this Gendered Household Type"
         ##Number of people in this gendered household type##
  ),
  tibble::tibble(ic = "EG-d", udn ="3.2.4.2"
         , name = "Number of People in this Gendered Household Type"
         ##Household type: Disaggregates Not Available##
         ##Percent of people living on less than $1.90/day in this gendered household type##
  ),
  tibble::tibble(ic = "EG-d", udn ="3.2.5.1"
         , name = "Percent of People Living on Less than $1.90/Day in this Gendered Household Type"
         ##Number of people in this gendered household type##
  ),
  tibble::tibble(ic = "EG-d", udn ="3.2.5.2"
         , name = "Number of People in this Gendered Household Type"
         ##EG-e (Prevalence)##
         ##In All ZOIs/Areas Combined (%)##
  ),
  ## EG-e ####
  tibble::tibble(ic = "EG-e"
  ...
  ## EG-g ####
  tibble::tibble(ic = "EG-g", udn ="3.1.1"
         , name = "In All ZOIs/Areas Combined (%)"
  ),
  tibble::tibble(ic = "EG-g", udn ="3.1.2"
         , name = "In Target/Aligned Country ZOI (%)"
  ),
  tibble::tibble(ic = "EG-g", udn ="3.1.3"
         , name = "In FFP Development Program Area (%)"
  ),
  tibble::tibble(ic = "EG-g", udn ="3.1.4"
         , name = "In Resilience to Recurrent Crisis Area (%)"
         ##Number of Households (All Household Types Together)##
  ),
  tibble::tibble(ic = "EG-g", udn ="3.2.1"
         , name = "In All ZOIs/Areas Combined"
  ),
  tibble::tibble(ic = "EG-g", udn ="3.2.2"
         , name = "In Target/Aligned Country ZOI"
  ),
  tibble::tibble(ic = "EG-g", udn ="3.2.3"
         , name = "In FFP Development Program Area"
  ),
  tibble::tibble(ic = "EG-g", udn ="3.2.4"
         , name = "In Resilience to Recurrent Crisis Area"
         ##Household type: Male and Female Adults (M&F)##
         ##Percent of Households in This Gendered Household Type Falling Below the Fixed Threshold for the Poorest Quintile of the Comparative Wealth Index##
  ),
  ...
  ## EG-h ####
  tibble::tibble(ic = "EG-h", udn ="3.1.1"
         , name = "In All ZOIs/Areas Combined (%)"
  ),
  tibble::tibble(ic = "EG-h", udn ="3.1.2"
         , name = "In Target/Aligned Country ZOI (%)"
  ),
  tibble::tibble(ic = "EG-h", udn ="3.1.3"
         , name = "In FFP Development Program Area (%)"
  ),
  tibble::tibble(ic = "EG-h", udn ="3.1.4"
         , name = "In Resilience to Recurrent Crisis Area (%)"
         ##Number of People (All Household Types Together)##
  ),
  tibble::tibble(ic = "EG-h", udn ="3.2.1"
         , name = "In All ZOIs/Areas Combined"
  ),
  tibble::tibble(ic = "EG-h", udn ="3.2.2"
         , name = "In Target/Aligned Country ZOI"
  ),
  tibble::tibble(ic = "EG-h", udn ="3.2.3"
         , name = "In FFP Development Program Area"
  ),
  tibble::tibble(ic = "EG-h", udn ="3.2.4"
         , name = "In Resilience to Recurrent Crisis Area"
         ##Household type: Male and Female Adults (M&F)##
         ##Mean Percent Shortfall of the Poor for People in this Gendered Household Type##
  ),
  ...
  ## EG.3-e ####
  tibble::tibble(ic = "EG.3-e", udn ="3.1.1.1"
         , name = "Agriculture"
  ),
  tibble::tibble(ic = "EG.3-e", udn ="3.1.1.2"
         , name = "Agro-Processing"
  ),
  tibble::tibble(ic = "EG.3-e", udn ="3.1.1.3"
         , name = "Trade and Transport"
  ),
  tibble::tibble(ic = "EG.3-e", udn ="3.1.1.4"
         , name = "Input Supply"
  ),
  tibble::tibble(ic = "EG.3-e", udn ="3.1.1.5"
         , name = "Hotel and Food Services"
         ##EG.3-f (A-WEAI)##
         ##In All ZOI/Areas Combined##
  ),
  ## EG.3-f ####
  tibble::tibble(ic = "EG.3-f"
  ...
  ## EG.3-e ####
  tibble::tibble(ic = "EG.3-g", udn ="3.1.1"
         , name = "Agriculture"
  ),
  tibble::tibble(ic = "EG.3-g", udn ="3.1.2"
         , name = "Agro-Processing"
  ),
  tibble::tibble(ic = "EG.3-g", udn ="3.1.3"
         , name = "Trade and Transport"
  ),
  tibble::tibble(ic = "EG.3-g", udn ="3.1.4"
         , name = "Input Supply"
  ),
  tibble::tibble(ic = "EG.3-g", udn ="3.1.5"
         , name = "Hotel and Food Services"
         ##EG.3-x1 (Number of Households)##
         ##Gendered Household Type##
  ),
  ## EG.3-x1 ####
  tibble::tibble(ic = "EG.3-x1"
  ...
  tibble::tibble(ic = "EG.3-x1"
    ...
    ## EG.3-2 ####
  ##Sex##
  tibble::tibble(ic = "EG.3-2", udn = "3.1.1", ms_d2 = "Male", name = "Male"
  ),
  tibble::tibble(ic = "EG.3-2", udn = "3.1.2", ms_d2 = "Female", name = "Female"
  ),
  tibble::tibble(ic = "EG.3-2", udn = c("3.1.3")
         , ms_d2 = "Not Applicable (for household members counted from HH-level interventions)"
         , name = "Not Applicable"
  ),
  tibble::tibble(ic = "EG.3-2"
         , udn = "3.1.4"
         , ms_d2 = "Disaggregates Not Available"
         , name = "Disaggregates Not Available"
         ##Age##
  ...
  ## Age ##
  tibble::tibble(ic = "EG.3-2", udn = "3.2.4"
         , ms_d2 = "Not Applicable (for household members counted from HH-level interventions)"
         , name = "Not Applicable"
  ),
  tibble::tibble(ic = "EG.3-2", udn = "3.2.5"
         , ms_d2 = "Disaggregates Not Available"
         , name = "Disaggregates Not Available"
  ),
  tibble::tibble(ic = "EG.3-2"
  ...
  tibble::tibble(ic = "EG.3-2_OULevel", udn ="3.1.2"
         , name = "Female"
  ),
  tibble::tibble(ic = "EG.3-2_OULevel", udn ="3.1.1"
         , name = "Male"
         ##Sex and Age##
  ),
  tibble::tibble(ic = "EG.3-2_OULevel"
         , udn = c("3.1.3", "3.2.4")
         , name = "Not Applicable"
  ),
  tibble::tibble(ic = "EG.3-2_OULevel"
  ...
  tibble::tibble(ic = "EG.3-2_OULevel", udn ="3.2.1"
         , name = "School-Aged Children"
  ),
  tibble::tibble(ic = "EG.3-2_OULevel", udn ="3.2.2"
         , name = "15-29"
  ),
  tibble::tibble(ic = "EG.3-2_OULevel", udn ="3.2.3"
         , name = "30+"
         ##Type of Individuals##
  ),
  tibble::tibble(ic = "EG.3-2_OULevel", udn ="3.3.1"
         , name = "Parents/Caregivers"
  ),
  tibble::tibble(ic = "EG.3-2_OULevel", udn ="3.3.2"
         , name = "Household Members"
  ),
  tibble::tibble(ic = "EG.3-2_OULevel", udn ="3.3.3"
         , name = "School-Aged Children"
  ),
  tibble::tibble(ic = "EG.3-2_OULevel", udn ="3.3.4"
         , name = "People in Government"
  ),
  tibble::tibble(ic = "EG.3-2_OULevel", udn ="3.3.5"
         , name = "People in USG-Assisted Private Sector Firms"
  ),
  tibble::tibble(ic = "EG.3-2_OULevel", udn ="3.3.6"
         , name = "People in Civil Society"
  ),
  tibble::tibble(ic = "EG.3-2_OULevel", udn ="3.3.7"
         , name = "Laborers (Non-Producer Diversified Livelihoods Participants)"
  ),
  tibble::tibble(ic = "EG.3-2_OULevel", udn ="3.3.8"
         , name = "Producer: Smallholder Farmer"
  ),
  tibble::tibble(ic = "EG.3-2_OULevel", udn ="3.3.9"
         , name = "Producer: Non-Smallholder Farmer"
  ),
  tibble::tibble(ic = "EG.3-2_OULevel", udn ="3.3.10"
         , name = "Producer: Aquaculture"
  ),
  tibble::tibble(ic = "EG.3-2_OULevel", udn ="3.3.11"
         , name = "Producer: Size Disaggregate Not Available"
  ),
  tibble::tibble(ic = "EG.3-2_OULevel", udn ="3.3.12"
         , name = "Type of Individual Not Applicable"
  ),
  tibble::tibble(ic = "EG.3-2_OULevel", udn ="3.3.13"
         , name = "Type of Individual Disaggregates Not Available"
         ##EG.3-x6, -7, -8##
  ),
  tibble::tibble(ic="EG.3-x6, -7, -8", ms_d3 =  "Association-applied"
         , name = "Association-Applied"
  ),
  tibble::tibble(ic="EG.3-x6, -7, -8", ms_d3 =  "Disaggregates Not Available"
         , name = "Disaggregates Not Available"
  ),
  tibble::tibble(ic="EG.3-x6, -7, -8", ms_d3 =  "Female"
         , name = "Female"
  ),
  tibble::tibble(ic="EG.3-x6, -7, -8", ms_d3 =  "Male"
         , name = "Male"
  ),
  tibble::tibble(ic="EG.3-x6, -7, -8", ms_d3 =  "Joint"
         , name = "Joint"
         ##EG.3-x9##
         ##Duration##
  ),
  tibble::tibble(ic="EG.3-x9"
         , ms_d2 = "New"
         , name = "New"
  ),
  tibble::tibble(ic="EG.3-x9"
  ...
  ##EG.3.1-c##
  ##Value of exports##
  tibble::tibble(ic = "EG.3.1-c",  udn = c("3.1", "3.1.1", "3.1.2"), name = "[Commodity (From DIS)]"
  ),
         ##EG.3.1-x12 (Policies)##
         ##Policy Area##
  tibble::tibble(ic = "EG.3.1-x12"
  ...
  tibble::tibble(ic = "EG.3.2-7", ms_d3 =  "Phase of Research (double-counting allowed)"
         , name = "Phase of Research (Double-Counting Allowed)"
         ##Total Number of Unique Technologies/Practices (No Double-Counting)##
  ),
  tibble::tibble(ic = "EG.3.2-7"
  ...
  tibble::tibble(ic = "EG.4.2-7"
         , udn ="3.1.2"
         , name = "Female"
         ##Males##
  ),
  tibble::tibble(ic = "EG.4.2-7", udn ="3.1.1"
         , name = "Male"
         ##DNA##
  ),
  tibble::tibble(ic = "EG.4.2-7", udn ="3.1.3"
         , name = "Disaggregates Not Available"
         ##15-29##
  ),
  tibble::tibble(ic = "EG.4.2-7", udn ="3.2.1"
         , name = "15-29"
         ##30+##
  ),
  tibble::tibble(ic = "EG.4.2-7", udn ="3.2.2"
         , name = "30+"
         ##DNA##
  ),
  tibble::tibble(ic = "EG.4.2-7", udn ="3.2.3"
         , name = "Disaggregates Not Available"
         ##Savings##
  ),
  tibble::tibble(ic = "EG.4.2-7", udn ="3.3.1"
         , name = "Savings"
         ##Credit##
  ),
  tibble::tibble(ic = "EG.4.2-7", udn ="3.3.2"
         , name = "Credit"
         ##DNA##
  ),
  tibble::tibble(ic = "EG.4.2-7", udn ="3.3.3"
         , name = "Disaggregates Not Available "
         ##New##
  ),
  tibble::tibble(ic = "EG.4.2-7", udn ="3.4.1"
         , name = "New"
         ##Continuing##
  ),
  tibble::tibble(ic = "EG.4.2-7", udn ="3.4.2"
         , name = "Continuing"
         ##DNA##
  ),
  tibble::tibble(ic = "EG.4.2-7", udn ="3.4.3"
         , name = "Disaggregates Not Available "
         ##EG.10.4-7 (Resource Type)##
         ##Sex##
  ),
  ...
  tibble::tibble(ic = "ES.5-1", udn ="3.1.2"
         , name = "Female"
         ##Males##
  ),
  tibble::tibble(ic = "ES.5-1", udn ="3.1.1"
         , name = "Male"
         ##DNA##
  ),
  tibble::tibble(ic = "ES.5-1", udn ="3.1.3"
         , name = "Disaggregates Not Available"
         ##15-29##
  ),
  tibble::tibble(ic = "ES.5-1", udn ="3.2.1"
         , name = "15-29"
         ##30+##
  ),
  tibble::tibble(ic = "ES.5-1", udn ="3.2.2"
         , name = "30+"
         ##DNA##
  ),
  tibble::tibble(ic = "ES.5-1", udn ="3.2.3"
         , name = "Disaggregates Not Available"
         ##New##
  ),
  tibble::tibble(ic = "ES.5-1", udn ="3.3.1"
         , name = "New"
         ##Continuing##
  ),
  tibble::tibble(ic = "ES.5-1", udn ="3.3.2"
         , name = "Continuing"
         ##DNA##
  ),
  tibble::tibble(ic = "ES.5-1", udn ="3.3.3"
         , name = "Disaggregates Not Available"
         ##Community Asset##
  ),
  tibble::tibble(ic = "ES.5-1", udn ="3.4.1"
         , name = "Community Asset"
         ##Human Assets/Capital##
  ),
  tibble::tibble(ic = "ES.5-1", udn ="3.4.2"
         , name = "Human Assets/Capital"
         ##Household Assets##
  ),
  tibble::tibble(ic = "ES.5-1", udn ="3.4.3"
         , name = "Household Assets"
         ##DNA##
  ),
  tibble::tibble(ic = "ES.5-1", udn ="3.4.4"
         , name = "Disaggregation Not Available"
         ##HL.8.2-2 (Participants by Sex)##
         ##Females##
  ),
  tibble::tibble(ic = "HL.8.2-2", udn ="3.1.2"
         , name = "Female"
         ##Males##
  ),
  tibble::tibble(ic = "HL.8.2-2", udn ="3.1.1"
         , name = "Male"
         ##DNA##
  ),
  tibble::tibble(ic = "HL.8.2-2", udn ="3.1.3"
         , name = "Disaggregates Not Available"
         ##Urban##
  ),
  tibble::tibble(ic = "HL.8.2-2", udn ="3.2.1"
         , name = "Urban"
         ##Rural##
  ),
  tibble::tibble(ic = "HL.8.2-2", udn ="3.2.2"
         , name = "Rural"
         ##DNA##
  ),
  tibble::tibble(ic = "HL.8.2-2", udn ="3.2.3"
         , name = "Disaggregates Not Available"
         ##1st Quintile##
  ),
  tibble::tibble(ic = "HL.8.2-2", udn ="3.3.1"
         , name = "1st Wealth Quintile"
         ##2nd Quintile##
  ),
  tibble::tibble(ic = "HL.8.2-2", udn ="3.3.2"
         , name = "2nd Wealth Quintile"
         ##3rd Quintile##
  ),
  tibble::tibble(ic = "HL.8.2-2", udn ="3.3.3"
         , name = "3rd Wealth Quintile"
         ##4th Quintile##
  ),
  tibble::tibble(ic = "HL.8.2-2", udn ="3.3.4"
         , name = "4th Wealth Quintile"
         ##5th Quintile##
  ),
  tibble::tibble(ic = "HL.8.2-2", udn ="3.3.5"
         , name = "5th Wealth Quintile"
         ##DNA##
  ),
  tibble::tibble(ic = "HL.8.2-2", udn ="3.3.6"
         , name = "Disaggregates Not Available"
  ...
  tibble::tibble(ic = "HL.9-1", udn ="3.1.2"
         , name = "Female"
         ##Males##
  ),
  tibble::tibble(ic = "HL.9-1", udn ="3.1.1"
         , name = "Male"
         ##DNA##
  ),
  tibble::tibble(ic = "HL.9-1", udn ="3.1.3"
         , name = "Disaggregates Not Available"
         ##FTFMS##
  ),
  tibble::tibble(ic = "HL.9-1"
         , ms_d1 ="Sex (no double-counting allowed)"
         , name = "ms_d2"
         ##Number of children under five whose parents/caretakers received behavior change communication interventions that promote essential infant and young child feeding behaviors##
  ),
  tibble::tibble(ic = "HL.9-1", udn ="3.2.1"
  ...
  tibble::tibble(ic = "HL.9-1", udn ="3.2.2"
  ...
  tibble::tibble(ic = "HL.9-1", udn ="3.2.3"
  ...
  tibble::tibble(ic = "HL.9-1", udn ="3.2.4"
  ...
  tibble::tibble(ic = "HL.9-1", udn ="3.2.5"
  ...
  tibble::tibble(ic = "HL.9-1", udn ="3.2.6"
  ...
  tibble::tibble(ic = "HL.9-1", udn ="3.2.7"
  ...
  tibble::tibble(ic = "HL.9-3", udn ="3.1.1"
         , name = "Women < 19"
  ),
  tibble::tibble(ic = "HL.9-3"
         , ms_d2 = "Number of women < 19 years of age"
         , name = "Women < 19"
         ##Women >= 19##
  ),
  tibble::tibble(ic = "HL.9-3", udn ="3.1.2"
         , name = "Women >= 19"
  ),
  tibble::tibble(ic = "HL.9-3"
  ...
  tibble::tibble(ic = "HL.9-3", udn ="3.1.3"
         , name = "Disaggregates Not Available"
  ),
  tibble::tibble(ic = "HL.9-3"
         , ms_d2 = "Disaggregates Not Available"
  ...
  tibble::tibble(ic = "HL.9-3", udn ="3.2.1"
  ...
  tibble::tibble(ic = "HL.9-3", udn ="3.2.2"
  ...
  tibble::tibble(ic = "HL.9-3", udn ="3.2.3"
  ...
  tibble::tibble(ic = "HL.9-3", udn ="3.2.4"
  ...
  tibble::tibble(ic = "HL.9-3", udn ="3.2.5"
  ...
  tibble::tibble(ic = "HL.9-4", udn ="3.1.2"
         , name = "Female"
         ##Males##
  ),
  tibble::tibble(ic = "HL.9-4", udn ="3.1.1"
         , name = "Male"
         ##DNA##
  ),
  tibble::tibble(ic = "HL.9-4", udn ="3.1.3"
         , name = "Disaggregates Not Available"
         ##FTFMS##
  ),
  tibble::tibble(ic = "HL.9-4"
         , ms_d1 ="Sex"
         , name = "ms_d2"
         ##Non-degree seeking trainees##
  ),
  tibble::tibble(ic = "HL.9-4", udn ="3.2.1"
  ...
  tibble::tibble(ic = "HL.9-4", udn ="3.2.2"
  ...
  tibble::tibble(ic = "HL.9-4", udn ="3.2.3"
  ...
  tibble::tibble(ic = "HL.9-4", udn ="3.2.4"
  ...
  tibble::tibble(ic = "HL.9-4", udn ="3.2.5"
         , name = "Disaggregates Not Available"
  ),
  tibble::tibble(ic = "HL.9-4"
         , ms_d2 = "Disaggregates Not Available"
  ...
  tibble::tibble(ic = "RESIL-1"
         , udn = c("3.1.1", "3.1.2")
         , name = "Total Number of Plans"
  ),
  tibble::tibble(system = "ftfms"
         , ic = "RESIL-1"
  ...
  tibble::tibble(system = "ftfms", ic = "RESIL-1"
         , ms_d4 = "Implemented"
         , name = "Implemented"
         ##Institutionalized##
  ),
  ...
  tibble::tibble(ic = c("EG.3.2-x20", "EG.3.2-x25", "EG.3.2-x27", "EG.3.2-x29"
                , "EG.3.2-x34", "EG.3.2-x37", "EG.3.2-x41", "EG.5.2-x1", "FTF-x01")
         , name = "ms_d2"
         ##Commodity##
  ),
  tibble::tibble(ic = c("EG.3.2-x23", "EG.3.3-x11")
         , name = "ms_d1"
  )
)
...
d1 <-  dplyr::bind_rows(
  ...
  ##Location##
  tibble::tibble(ic = "EG.3-x1", ms_d1 = "Location", name = "Location"
  ),
  ##Duration##
  tibble::tibble(ic = "EG.3-x1", ms_d1 = "Duration", name = "Duration"
  ),
  ##EG.3-2####
  ##Sex##
  tibble::tibble(ic = "EG.3-2"
  ...
  tibble::tibble(ic = "EG.3-x6, -7, -8", ms_d2 = "Value of Sales (USD)", name = "Value of Sales (USD)"
  ),
  ##EG.3-x9##
  tibble::tibble(ic = "EG.3-x9", ms_d1 = "Duration", name = "Duration"
  ),
  tibble::tibble(ic = "EG.3-x9", ms_d1 = "Location", name = "Location"
  ),
  tibble::tibble(ic = "EG.3-x9", ms_d1 = "Sex of job-holder", name = "Sex of Job-Holder"
  ),
  ##EG.3-10-11-12####
  ##1##
  tibble::tibble(ic = "EG.3-10-11-12_CROP"
         , udn =  c("3.1.1.1.8.1.2", "3.1.1.1.9.1.2", "3.1.1.1.10.1.2"
  ...
  tibble::tibble(ic = "EG.3-10-11-12_DAIRY"
         , udn =  c("3.1.1.1.8.1.2", "3.1.1.1.9.1.2", "3.1.1.1.10.1.2"
                    , "3.1.1.1.8.1.1", "3.1.1.1.9.1.1", "3.1.1.1.10.1.1"
                    , "3.1.1.1.8.1.3", "3.1.1.1.9.1.3", "3.1.1.1.10.1.3"
                    , "3.1.1.1.8.2.2", "3.1.1.1.9.2.2", "3.1.1.1.10.2.2"
  ...
  tibble::tibble(ic = "EG.3-10-11-12_EGGS"
         , udn =  c("3.1.1.1.8.1.2", "3.1.1.1.9.1.2", "3.1.1.1.10.1.2"
                    , "3.1.1.1.8.1.1", "3.1.1.1.9.1.1", "3.1.1.1.10.1.1"
                    , "3.1.1.1.8.1.3", "3.1.1.1.9.1.3", "3.1.1.1.10.1.3"
                    , "3.1.1.1.8.2.2", "3.1.1.1.9.2.2", "3.1.1.1.10.2.2"
  ...
  tibble::tibble(ic = "EG.3-10-11-12_LIVSTK"
         , udn =  c("3.1.1.1.8.1.2", "3.1.1.1.9.1.2", "3.1.1.1.10.1.2"
                    , "3.1.1.1.8.1.1", "3.1.1.1.9.1.1", "3.1.1.1.10.1.1"
                    , "3.1.1.1.8.1.3", "3.1.1.1.9.1.3", "3.1.1.1.10.1.3"
                    , "3.1.1.1.8.2.2", "3.1.1.1.9.2.2", "3.1.1.1.10.2.2"
  ...
  tibble::tibble(ic = "EG.3-10-11-12_OTHER"
         , udn =  c("3.1.1.1.8.1.2", "3.1.1.1.9.1.2", "3.1.1.1.10.1.2"
                    , "3.1.1.1.8.1.1", "3.1.1.1.9.1.1", "3.1.1.1.10.1.1"
                    , "3.1.1.1.8.1.3", "3.1.1.1.9.1.3", "3.1.1.1.10.1.3"
                    , "3.1.1.1.8.2.2", "3.1.1.1.9.2.2", "3.1.1.1.10.2.2"
  ...
  tibble::tibble(ic = "EG.3-10-11-12_PONDAQ"
         , udn =  c("3.1.1.1.8.1.2", "3.1.1.1.9.1.2", "3.1.1.1.10.1.2"
                    , "3.1.1.1.8.1.1", "3.1.1.1.9.1.1", "3.1.1.1.10.1.1"
                    , "3.1.1.1.8.1.3", "3.1.1.1.9.1.3", "3.1.1.1.10.1.3"
                    , "3.1.1.1.8.2.2", "3.1.1.1.9.2.2", "3.1.1.1.10.2.2"
  ...
  ##EG.3.1-c####
  ##Value of exports##
  tibble::tibble(ic = "EG.3.1-c", udn = c("3.1.1", "3.1.2"),  name = "Commodity"
  ),
  tibble::tibble(ic = "EG.3.1-c", udn = "3.1",  name = "Value of Exports (USD)"
  ),
  ##EG.3.1-d####
  ##Milestone##
  tibble::tibble(ic = "EG.3.1-d", udn = "3.1.1", name = "Milestones Uploaded"
  ),
  ##EG.3.1-1 (Kms)####
  ##Improved##
  tibble::tibble(ic = "EG.3.1-1", udn = "3.1", ms_d1 = "Improved", name = "Improved"
  ),
  ##Constructed (New)##
  tibble::tibble(ic = "EG.3.1-1", udn =  "3.2", ms_d1 = "Constructed (new)", name = "Constructed (New)"
  ),
  ##DNA##
  tibble::tibble(ic = "EG.3.1-1", udn =  "3.3", ms_d1 = "Disaggregates Not Available"
         , name = "Disaggregates Not Available"
  ),
  ##EG.3.1-x2####
  tibble::tibble(ic = "EG.3.1-x2", name = "Number of Hectares"
  ),
  ##EG.3.1-x12 (Policies)####
  ##Policy Area##
  tibble::tibble(ic = "EG.3.1-x12", ms_d1 = "Policy Area", name = "Policy Area"
  ),
  ##Process/Step##
  tibble::tibble(ic = "EG.3.1-x12", ms_d1 = "Process/Step", name = "Process/Step"
  ),
  ##EG.3.1-x13####
  tibble::tibble(ic = "EG.3.1-x13", ms_d1 = "Female", name = "Female"
  ),
  tibble::tibble(ic = "EG.3.1-x13", ms_d1 = "Male", name = "Male"
  ),
  tibble::tibble(ic = "EG.3.1-x13", ms_d1 = "Joint", name = "Joint"
  ),
  tibble::tibble(ic = "EG.3.1-x13", ms_d1 = "Communal", name = "Communal"
  ),
  tibble::tibble(ic = "EG.3.1-x13", ms_d1 = "Disaggregates Not Available"
         , name = "Disaggregates Not Available"
  ),
  ##EG.3.1-14####
  ##USG Commitment Amount##
  tibble::tibble(ic = "EG.3.1-14", udn =  "3.1.1", ms_d2 = "USG commitment amount ($USD)"
         , name = "USG Commitment Amount"
  ),
  ##Private Sector Partner Leveraged Amount##
  tibble::tibble(ic = "EG.3.1-14", udn =  "3.1.2"
         , ms_d2 = "Private sector partner leveraged amount ($USD)"
         , name = "Private Sector Partner Leveraged Amount"
  ),
  ##EG.3.1-15####
  ##Private Sector Partner Leveraged Amount##
  tibble::tibble(ic = "EG.3.1-15", udn = "3.1", name = "Private Sector Partner Leveraged Amount"
  ),
  ##EG.3.1-x21####
  tibble::tibble(ic = "EG.3.1-x21", name = "Number of Climate Vulnerability Assessments"
  ),
  ##EG.3.1-x22 (Hectares)####
  tibble::tibble(ic = "EG.3.1-x22", name = "ms_d1"
  ),
  ##EG.3.2-x1####
  tibble::tibble(ic = "EG.3.2-x1", ms_d1 = "Type of Individual"
         , name = "ms_d2"
  ),
  tibble::tibble(ic = "EG.3.2-x1", ms_d1 = "Sex", name = "ms_d1"
  ),
  ##EG.3.2-x3####
  tibble::tibble(ic = "EG.3.2-x3", ms_d1 = "Sex of owner / producer"
         , name = "Sex of Owner/Producer"
  ),
  tibble::tibble(ic = "EG.3.2-x3", name = "ms_d1"
  ),
  ##EG.3.2-x4####
  tibble::tibble(ic = "EG.3.2-x4", ms_d1 = "Duration", name = "Duration"
  ),
  tibble::tibble(ic = "EG.3.2-x4"
  ...
  ##EG.3.2-x5####
  tibble::tibble(ic = "EG.3.2-x5"
         , ms_d2 = "Agricultural post harvest transformation"
         , name = "Agricultural Post Harvest Transformation"
  ),
  tibble::tibble(ic = "EG.3.2-x5", ms_d2 = "Agricultural production"
         , name = "Agricultural Production"
  ),
  tibble::tibble(ic = "EG.3.2-x5", name = "ms_d2"
  ),
  ##EG.3.2-x6####
  tibble::tibble(ic = "EG.3.2-x6", ms_d1 = "Sex of recipient"
         , name = "Sex of Recipient(s)"
  ),
  tibble::tibble(ic = "EG.3.2-x6", ms_d1 = "Type of loan recipient"
  ...
  ##EG.3.2-x17####
  tibble::tibble(ic = "EG.3.2-x17", ms_d1 = "Producers", name = "Producers"
  ),
  tibble::tibble(ic = "EG.3.2-x17", ms_d1 = "Others", name = "Others"
  ),
  ##EG.3.2-x18 (Hectares Under Improved Management)####
  tibble::tibble(ic = "EG.3.2-x18", name = "Cultivated Land"
  ),
  ##EG.3.2-x19 (Value by Type and Sex####
  tibble::tibble(ic = "EG.3.2-x19", name = "Commodity"
  ),
  ##EG.3.2-x22 (PSI Value)####
  tibble::tibble(ic = "EG.3.2-x22", name = "Value of New Private Sector Capital Investment"
  ),
  ##EG.3.2-2####
  ##Sex##
  tibble::tibble(ic = "EG.3.2-2", udn =  c("3.1.2", "3.1.1", "3.1.3")
         , ms_d1 = "Sex", name = "Sex"
  ),
  ##Duration##
  tibble::tibble(ic = "EG.3.2-2", udn =  c("3.2.2", "3.2.1", "3.2.3")
  ...
  ##ES.5-1####
  ##Sex##
  tibble::tibble(ic = "ES.5-1", udn =  c("3.1.2", "3.1.1", "3.1.3"), name = "Sex"
  ),
  ##Age##
  tibble::tibble(ic = "ES.5-1", udn =  c("3.2.1", "3.2.2", "3.2.3"), name = "Age Category"
  ),
  ##Duration##
  tibble::tibble(ic = "ES.5-1"
         , udn =  c("3.3.1", "3.3.2", "3.3.3")
         , name = "Duration"
  ),
  ##Type of Asset##
  tibble::tibble(ic = "ES.5-1", udn =  c("3.4.1", "3.4.2", "3.4.3", "3.4.4")
         , name = "Type of Asset Strengthened"
  ),
  ##GNDR-2 (Number)####
  ##Number of Female Program Participants##
  tibble::tibble(ic = "GNDR-2", udn =  "3.1"
         , ms_d1 = "Numerator: Number of female program participants"
         , name = "Number of Female Program Participants"
  ),
  ##Number of Total Program Participants##
  tibble::tibble(ic = "GNDR-2", udn =  "3.2"
         , ms_d1 = "Denominator: Total number of male and female participants in the program"
         , name = "Number of Total Program Participants"
  ),
  ## HL.8.2-2####
  ##Sex##
  tibble::tibble(ic = "HL.8.2-2", udn =  c("3.1.2", "3.1.1", "3.1.3"), name = "Sex"
  ),
  ##Location##
  tibble::tibble(ic = "HL.8.2-2", udn =  c("3.2.1", "3.2.2", "3.2.3"), name = "Location"
  ),
  ##Wealth Quintile##
  tibble::tibble(ic = "HL.8.2-2"
         , udn =  c("3.3.1", "3.3.2", "3.3.3", "3.3.4", "3.3.5", "3.3.6")
         , name = "Wealth Quintile"
  ),
  ##HL.8.2-5####
  ##Urban##
  tibble::tibble(ic = "HL.8.2-5", udn =  c("3.2.1.1", "3.2.1.2")
         , ms_d2 = "Urban - percentage of households with soap and water at a handwashing station"
         , name = "Urban"
  ),
  ##Rural##
  tibble::tibble(ic = "HL.8.2-5", udn =  c("3.2.2.1", "3.2.2.2")
         , ms_d2 = "Rural - percentage of households with soap and water at a handwashing station"
         , name = "Rural"
  ),
  ##DNA##
  tibble::tibble(ic = "HL.8.2-5", udn =  c("3.2.3.1", "3.2.3.2")
  ...
  ##HL.9-1####
  ##Sex##
  tibble::tibble(ic = "HL.9-1", udn =  c("3.1.2", "3.1.1", "3.1.3")
  ...
  ##HL.9-2 (Participants by Sex)####
  ##Female##
  tibble::tibble(ic = "HL.9-2", udn = "3.2", name = "Female"
  ),
  ##Males##
  tibble::tibble(ic = "HL.9-2", udn = "3.1", name = "Male"
  ),
  ##DNA##
  tibble::tibble(ic = "HL.9-2", udn = "3.3", name = "Disaggregates Not Available"
  ),
  ##FTFMS##
  tibble::tibble(ic = "HL.9-2", name = "ms_d1"
  ),
  ##HL.9-3####
  ##Women < 19##
  tibble::tibble(ic = "HL.9-3", udn =  c("3.1.1", "3.1.2", "3.1.3")
         , ms_d1 = "Age (no double counting)", name = "Age"
  ),
  ##Intervention##
  ##Number of Women Receiving Iron and Folic Acid Supplementation##
  tibble::tibble(ic = "HL.9-3", udn =  c("3.2.1", "3.2.2", "3.2.3", "3.2.4", "3.2.5")
         , ms_d1 = "Intervention (double-counting allowed)"
         , name = "Intervention (Double-Counting Allowed)"
  ),
  ##HL.9-4####
  ##Sex##
  tibble::tibble(ic = "HL.9-4", udn =  c("3.1.2", "3.1.1", "3.1.3"), ms_d1 = "Sex"
         , name = "Sex"
  ),
  ##Type of Training##
  tibble::tibble(ic = "HL.9-4", udn =  c("3.2.1", "3.2.2", "3.2.3", "3.2.4", "3.2.5")
         , ms_d1 = "Type of Training", name = "Type of Training"
  ),
  ##HL.9-a####
  ##Children 0-59##
  tibble::tibble(ic = "HL.9-a"
  ...
  tibble::tibble(ic = "HL.9.1-a", udn =  c("3.5.1.1", "3.5.1.2", "3.5.1.3", "3.5.1.4")
  ...
  tibble::tibble(ic = "HL.9.1-a", udn =  c("3.5.2.1", "3.5.2.2", "3.5.2.3", "3.5.2.4")
  ...
  tibble::tibble(ic = "HL.9.1-b", udn =  c("3.5.1.1", "3.5.1.2", "3.5.1.3", "3.5.1.4")
  ...
  tibble::tibble(ic = "HL.9.1-b", udn =  c("3.5.2.1", "3.5.2.2", "3.5.2.3", "3.5.2.4")
  ...
  tibble::tibble(ic = "HL.9.1-d", udn =  c("3.1.1", "3.1.2", "3.1.3", "3.1.4")
  ...
  tibble::tibble(ic = "HL.9.1-d", udn =  c("3.2.1", "3.2.2", "3.2.3", "3.2.4")
  ...
  tibble::tibble(ic = "HL.9.1-d", udn =  c("3.3.1", "3.3.2", "3.3.3", "3.3.4")
  ...
  tibble::tibble(ic = "HL.9.1-d", udn =  c("3.4.1", "3.4.2", "3.4.3", "3.4.4")
  ...
  tibble::tibble(ic = "HL.9.1-d", udn =  c("3.5.1", "3.5.2", "3.5.3", "3.5.4")
  ...
  tibble::tibble(ic = "HL.9.1-d", udn =  c("3.6.1", "3.6.2", "3.6.3", "3.6.4")
         , name = "Number of Women 19-49 Years of Age"
  ),
  ##RESIL-1 (Number of Plans by Type -  Double Counting)####
  ##Government##
  tibble::tibble(ic = "RESIL-1", udn = "3.1.1", name = "Government - Number of Plans"
  ),
  tibble::tibble(ic = "RESIL-1", ms_d2 = "Government - number of plans"
         , name = "Government - Number of Plans"
  ),
  tibble::tibble(ic = "RESIL-1", udn =  c("3.1.1.1.1", "3.1.1.1.2", "3.1.1.1.3", "3.1.1.1.4")
  ...
  ##Community##
  tibble::tibble(ic = "RESIL-1", udn = "3.1.2", name = "Community - Number of Plans"
  ),
  tibble::tibble(ic = "RESIL-1", ms_d2 = "Community - number of plans"
         , name = "Community - Number of Plans"
  ),
  tibble::tibble(ic = "RESIL-1", udn =  c("3.1.2.1.1", "3.1.2.1.2", "3.1.2.1.3", "3.1.2.1.4")
  ...
  ##RESIL-a####
  ##ARSSI Score##
  tibble::tibble(ic = "RESIL-a", udn =  c("3.1.1", "3.1.2", "3.1.3", "3.1.4")
         , name = "ARSSI Score"
  ),
  ##Number of Households (All Household Types Together)##
  tibble::tibble(ic = "RESIL-a", udn =  c("3.2.1", "3.2.2", "3.2.3", "3.2.4")
         , name = "Number of Households (All Household Types Together)"
  ),
  ##Household type: Male and Female Adults (M&F)##
  tibble::tibble(ic = "RESIL-a"
         , udn =  c("3.3.1.1", "3.3.1.2", "3.3.1.3", "3.3.1.4", "3.3.2.1"
                    , "3.3.2.2", "3.3.2.3", "3.3.2.4")
         , name = "Household Type: Male and Female Adults (M&F)"
  ),
  ...
  tibble::tibble(ic = "RESIL-b", udn =  c("3.1.1", "3.1.2", "3.1.3", "3.1.4")
         , name = "Overall Index of Social Capital at the Household Level"
  ),
  ##Bonding Sub-Index##
  tibble::tibble(ic = "RESIL-b", udn =  c("3.2.1", "3.2.2", "3.2.3", "3.2.4")
         , name = "Bonding Sub-Index"
  ),
  ##Bridging Sub-Index##
  tibble::tibble(ic = "RESIL-b", udn =  c("3.3.1", "3.3.2", "3.3.3", "3.3.4")
         , name = "Bridging Sub-Index"
  ),
  ##Total Number of Households##
  tibble::tibble(ic = "RESIL-b", udn =  c("3.4.1", "3.4.2", "3.4.3", "3.4.4")
         , name = "Total Number of Households"
  ),
  ##Household Type: Male and Female Adults (M&F)##
  tibble::tibble(ic = "RESIL-b"
         , udn =  c("3.5.1.1", "3.5.1.2", "3.5.1.3", "3.5.1.4", "3.5.2.1"
                    , "3.5.2.2", "3.5.2.3", "3.5.2.4", "3.5.3.1", "3.5.3.2"
                    , "3.5.3.3", "3.5.3.4")
         , name = "Household Type: Male and Female Adults (M&F)"
