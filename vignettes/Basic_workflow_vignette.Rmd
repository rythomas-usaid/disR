...
## Using `magnus` data
It is recommended to create a parent folder and clone the repo inside of the parent folder. Within the parent folder, create a dolcer called "downloads" to save data downloaded from Google Drive.
|-Rscripts
| |- downloads
| |- disR
